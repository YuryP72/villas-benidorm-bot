...
TEXTS = {
    "en": {
        ...
        "btn_price": "💶 Price", "btn_location": "📍 Location", "btn_plans": "🗺️ Plans", "btn_gallery": "🖼️ Gallery", "btn_book": "📅 Book Viewing", "btn_lang": "🌐 Language", "btn_villas": "🏘️ All 3 Villas",
        ...
        "book_admin": "🔥 *NEW BOOKING*", "new_lead": "🔥 New lead", "reply_hint": "Reply to answer", "back": "⬅️ Back", "menu_hint": "Choose:", "villas_list": "🏘️ 3 Villas from villas-benidorm.com:"
    },
    "es": {
        ...
        "main_menu": "🏡 *{villa_name} — {price}*", "btn_price": "💶 Precio", "btn_location": "📍 Ubicación", "btn_plans": "🗺️ Planos", "btn_gallery": "🖼️ Galería", "btn_book": "📅 Reservar", "btn_lang": "🌐 Idioma", "btn_villas": "🏘️ Las 3 Villas",
        "price_title": "💶 *{villa_name} — {price}*", "price_text": " *{villa_name}*\nPrecio: *{price}*\n\n• {built} • {beds_detail}\n• Piscina infinita, Smart Home\n• A+, triple vidrio\n\nEntrega: *{delivery}*",
        "location_title": "📍 *Ubicación*", "location_text": "Finestrat — Benidorm\n1,2 km a Playa Levante\n45 min a Alicante\nEntrega 2027",
        "plans_title": "🗺️ *{villa_name}*", "plans_text": "Planos:", "gallery_title": "🖼️ *{villa_name}*", "book_title": "📅 *Reservar {villa_name}*",
        "book_start": "Visita {villa_name} {price}\n\n¿Nombre?", "book_phone": "Teléfono:", "book_date": "¿Fecha?", "book_comment": "¿Preferencias?",
        "book_confirm_user": "✅ ¡Gracias {name}!\n\nSolicitud {villa_name} {price} enviada.\nFecha: {date}\nTel: {phone}",
        "book_admin": "🔥 *NUEVA RESERVA*", "new_lead": "🔥 Nuevo lead", "reply_hint": "Responde", "back": "⬅️ Volver", "menu_hint": "Elige:", "villas_list": "🏘️ 3 Villas:"
    },
    "ru": {
        ...
        "main_menu": "🏡 *{villa_name} — {price}*", "btn_price": "💶 Цена", "btn_location": "📍 Локация", "btn_plans": "🗺️ Планы", "btn_gallery": "🖼️ Галерея", "btn_book": "📅 Запись", "btn_lang": "🌐 Язык", "btn_villas": "🏘️ Все 3 виллы",
        "price_title": "💶 *{villa_name} — {price}*", "price_text": " *{villa_name}*\nЦена: *{price}*\n\n• {built} • {beds_detail}\n• Бассейн, умный дом\n• A+, тройной стеклопакет\n\nСдача: *{delivery}*",
        "location_title": "📍 *Расположение*", "location_text": "Финестрат — Бенидорм\n1,2 км до пляжа\n45 мин до Аликанте\nСдача 2027",
        "plans_title": "🗺️ *{villa_name}*", "plans_text": "Планировки:", "gallery_title": "🖼️ *{villa_name}*", "book_title": "📅 *Запись {villa_name}*",
        ...
        "book_admin": "🔥 *НОВАЯ ЗАПИСЬ*", "new_lead": "🔥 Новый лид", "reply_hint": "Ответь Reply", "back": "⬅️ Назад", "menu_hint": "Выберите:", "villas_list": "🏘️ 3 виллы:"
    }
}
...
async def cmd_start(m: types.Message, state: FSMContext):
    ...
    # FAST START: only 1 photo to avoid 50s spin-up timeout on Render free tier
...
async def cb_set_lang(cb: types.CallbackQuery):
    await cb.answer()  # answer fast to avoid hang
...
async def cb_plans(cb: types.CallbackQuery):
    ...
    # send plans one by one to avoid media_group timeout
...
async def cb_gallery(cb: types.CallbackQuery):
    ...
    # send 1-2 photos at a time to avoid hang
